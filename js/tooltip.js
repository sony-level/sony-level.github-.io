...
tippy('#linux-lang', { content: 'Linux', });
...
tippy('#RaspberryPi-lang', { content: 'Raspberry Pi', });
tippy('#adobe-lang', { content: 'Adobe Creative Cloud', });
tippy('#windows-lang', { content: 'Windows', });
tippy('#docker-lang', { content: 'Docker', });
tippy('#dockers-lang', { content: 'Burp Suite', });
tippy('#Harbor-lang', { content: 'Harbor', });
